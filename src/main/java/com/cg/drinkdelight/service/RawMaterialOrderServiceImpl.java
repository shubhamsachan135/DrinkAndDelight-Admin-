...
//		   if(suppEntity.getRawMaterials().contains(rawMatName)) {
//			List<RawMaterialStockEntity> rStockEntityList=suppEntity.getRawMaterials();
//	    	Iterator<RawMaterialStockEntity> iterator = rStockEntityList.iterator();
//		    while (iterator.hasNext()) {
//		    	RawMaterialStockEntity rStockEntity = iterator.next();
//		        if (rStockEntity.getRawMaterialQuantity()>=rawMatQuantity) {
//		        	RawMaterialOrderEntity rawMatOrder=new RawMaterialOrderEntity(rStockEntity.getRawMaterialId(),
//		        			rawMatName,suppEntity.getSupplierId(),rawMatQuantity,LocalDate.now());
//		        	   rMatDao.save(rawMatOrder);
